...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DJHomeViewController *homeController = [[DJHomeViewController alloc] init];
    homeController.tabBarItem.title = @"首页";

    DJMembersViewController *membersViewController = [[DJMembersViewController alloc] init];
    membersViewController.tabBarItem.title = @"会员";

    DJMeViewController *meViewController = [[DJMeViewController alloc] init];
    meViewController.tabBarItem.title = @"我的";

    UITabBarController *tabBarController = [[UITabBarController alloc] init];
    tabBarController.tabBar.barTintColor = [UIColor whiteColor];
    tabBarController.tabBar.translucent = NO;
    tabBarController.viewControllers = @[homeController, membersViewController, meViewController];
